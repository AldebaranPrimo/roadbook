...
- **2026-04-24** (rev 3) — Aggiunta allo Step 5 della Fase 4: ogni commit destinato a diventare una PR deve includere `@copilot esegui revisione` nel messaggio, per attivare la review automatica di GitHub Copilot come secondo pass complementare alla self-review dello Step 4.5.
